...
import com.lumata.lib.lupa.content.Feed;
...
public class HtmlExtractorTest {
	...
	@Test
	public void extractKeywordsFromMeta() throws IOException {
	...
	@Test
	public void extractDescriptionFromMeta() throws IOException {
		// meta description
	...
	@Test
	public void extractPreviewUrlFromMeta() throws IOException {
	...
	@Test
	public void getRssFeedAddress() throws IOException {
		// rss and atom
	...
	@Test
	public void extractEmbededYoutubeVideo() throws IOException {
		// normal http
	...
	@Test
	public void extractEmbededVimeoVideo() throws IOException {
	...
	@Test
	public void testHtmlRedirection() throws IOException {
	...
	@Test
	public void testHtmlRelativeRedirection() throws IOException {
	...
	/* --------------------------------- helper methods -- */
	private ReadableResource createMockResource(String url, String content) throws IOException {
	...
	private ServiceLocator createServiceLocatorMock() throws IOException {
	...
	private <E extends WebContent> void stubbScraping(String url, E mockedContent, Class<E> type) throws IOException {
		when(scraperMock.scrapContent(url)).thenReturn(mockedContent);
		when(scraperMock.scrapContent(url, type)).thenReturn(mockedContent);
	}
}
